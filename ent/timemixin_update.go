...
func (_u *TimeMixinUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *TimeMixinUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (_u *TimeMixinUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *TimeMixinUpdateOne {
	_u.modifiers = append(_u.modifiers, modifiers...)
	return _u
}
