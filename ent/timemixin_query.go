...
func (_q *TimeMixinQuery) ForUpdate(opts ...sql.LockOption) *TimeMixinQuery {
...
func (_q *TimeMixinQuery) ForShare(opts ...sql.LockOption) *TimeMixinQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
...
func (_q *TimeMixinQuery) Modify(modifiers ...func(s *sql.Selector)) *TimeMixinSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *TimeMixinSelect) Modify(modifiers ...func(s *sql.Selector)) *TimeMixinSelect {
